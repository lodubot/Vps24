...
async def view_bot(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    buttons = [
        [InlineKeyboardButton("▶️ Start/Restart", callback_data=f"mybots:restart:{bot_id}"),
         InlineKeyboardButton("⏹ Stop", callback_data=f"mybots:stop:{bot_id}")],
        [InlineKeyboardButton("📜 Logs", callback_data=f"logs:view:{bot_id}"),
         InlineKeyboardButton("📊 Stats", callback_data=f"dashboard:bot:{bot_id}")],
        [InlineKeyboardButton("🗑 Delete", callback_data=f"mybots:delete_confirm:{bot_id}")],
...
async def delete_confirm(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    buttons = [
        [InlineKeyboardButton("✅ Yes, delete", callback_data=f"mybots:delete:{bot_id}"),
         InlineKeyboardButton("❌ Cancel", callback_data=f"mybots:view:{bot_id}")],
    ]
