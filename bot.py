...
from handlers import home, upload, github, mybots, files, logs as logs_handler, env, dashboard, backup, settings, account
...
HANDLER_MODULES = [home, upload, github, mybots, files, logs_handler, env, dashboard, backup, settings, account]
